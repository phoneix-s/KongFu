...
animation_start = {'flip': False,
                   'sound': None,
                   'frames': [{'body_points': [[134, 60], [134, 102], [111, 116], [157, 116], [93, 139], [176, 139],
                                               [120, 150], [157, 150], [125, 175], [148, 175], [120, 255], [157, 250],
                                               [120, 315], [157, 315]], 'delay': 10}]}
animation_stand = {'flip': False,
                   'sound': None,
                   'frames': [{'body_points': [[133, 50], [133, 90], [104, 109], [158, 109], [99, 154], [163, 154],
                                               [94, 198], [167, 193], [113, 173], [143, 173], [108, 252], [148, 252],
                                               [108, 330], [148, 330]], 'delay': 10}]}
animation_standby = {'flip': False,
                     'sound': None,
                     'frames': [{'body_points': [[133, 67], [123, 111], [98, 116], [138, 121], [108, 141], [158, 161],
                                                 [138, 116], [183, 156], [108, 191], [128, 191], [98, 256], [143, 256],
                                                 [88, 320], [148, 315]], 'delay': 10}]}
animation_punch = {'flip': False,
                   'sound': sound_punch,
                   'frames': [{'body_points': [[133, 67], [123, 111], [98, 116], [138, 121], [108, 141], [158, 161],
                                               [138, 116], [183, 156], [108, 191], [128, 191], [98, 256], [143, 256],
                                               [88, 320], [148, 315]], 'delay': 10},
                              {'body_points': [[179, 75], [168, 118], [141, 118], [184, 129], [152, 135], [217, 129],
                                               [184, 118], [290, 124], [130, 194], [157, 205], [104, 264], [163, 275],
                                               [82, 328], [157, 328]], 'delay': 100}]}
animation_kick = {'flip': False,
                  'sound': sound_kick,
                  'frames': [{'body_points': [[133, 67], [123, 111], [98, 116], [138, 121], [108, 141], [158, 161],
                                              [138, 116], [183, 156], [108, 191], [128, 191], [98, 256], [143, 256],
                                              [88, 320], [148, 315]], 'delay': 10},
                             {'body_points': [[37, 50], [48, 94], [26, 116], [70, 105], [32, 155], [92, 144], [54, 122],
                                              [114, 166], [70, 188], [92, 177], [70, 254], [126, 150], [70, 320],
                                              [126, 220]], 'delay': 30},
                             {'body_points': [[19, 64], [34, 111], [8, 132], [65, 116], [24, 163], [97, 148], [50, 132],
                                              [76, 132], [76, 200], [97, 174], [81, 257], [170, 153], [86, 320],
                                              [242, 137]], 'delay': 100}]}
animation_flying_kick = {'flip': False,
                         'sound': sound_flying_kick,
                         'frames': [{'body_points': [[133, 67], [123, 111], [98, 116], [138, 121], [108, 141],
                                                     [158, 161], [138, 116], [183, 156], [108, 191], [128, 191],
                                                     [98, 256], [143, 256], [88, 320], [148, 315]], 'delay': 10},
                                    {'body_points': [[76, 5], [78, 51], [53, 64], [101, 58], [66, 92], [127, 94],
                                                     [94, 64], [129, 84], [92, 135], [112, 122], [64, 183], [156, 100],
                                                     [94, 220], [130, 170]], 'delay': 100},
                                    {'body_points': [[19, -56], [34, -9], [8, 12], [65, -4], [24, 43], [97, 28],
                                                     [50, 12], [76, 12], [76, 80], [97, 54], [30, 110], [170, 80],
                                                     [100, 120], [242, 100]], 'delay': 200}]}
animation_list = [animation_standby, animation_kick, animation_flying_kick, animation_punch, animation_punch,
                  animation_start, animation_stand]
...
class PkAnimator(object):
    ...
    def set_player1_animation(self, animation_index):
        self.player1_animation = animation_list[animation_index]

    def set_player2_animation(self, animation_index):
        self.player2_animation = animation_list[animation_index]
    ...
    def show_playground(self):
        ...
        cv2.putText(self.playground_image, text=self.winner_text, org=(100, 100), fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                    fontScale=2, color=(0, 255, 0), thickness=5)
        if self.show_help_flag == True:
            cv2.putText(self.playground_image, text="START: Raise hands above head        EXIT: Press 'Esc'",
                        org=(100, 50), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(0, 255, 0), thickness=1)
            cv2.putText(self.playground_image, text="Punch: Left or Right hand Up", org=(100, 80),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(0, 255, 0), thickness=1)
            cv2.putText(self.playground_image, text="Kick: Left leg Up", org=(100, 110),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(0, 255, 0), thickness=1)
            cv2.putText(self.playground_image, text="Flying Kick: Right leg Up", org=(100, 140),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(0, 255, 0), thickness=1)
        ...
        # cv2.setWindowProperty("Playground",cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
        cv2.moveWindow("Playground", 0, 0)
        # lock.release()
    ...
    def render_health_bar(self, health, pos, color):
        ...
        self.playground_image = cv2.rectangle(self.playground_image, pos,
                                              (pos[0] + int(200 * (health / 100)), pos[1] + 20), color, -1)
        self.playground_image = cv2.putText(self.playground_image, text=str(health), org=(pos[0] + 80, pos[1] + 15),
                                            fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(128, 128, 128),
                                            thickness=2)
        return self.playground_image

    def render_score(self, score, pos, color):
        self.playground_image = cv2.rectangle(self.playground_image, pos, (pos[0] + 60, pos[1] + 40), (255, 128, 64),
                                              -1)
        self.playground_image = cv2.rectangle(self.playground_image, (pos[0] + 2, pos[1] + 2),
                                              (pos[0] + 58, pos[1] + 38), color, -1)
        self.playground_image = cv2.putText(self.playground_image, text=str(score), org=(pos[0] + 10, pos[1] + 30),
    ...
    def play_animation_1_step(self):
        if self.player1_animation is not None:
            sound = self.player1_animation['sound']
            if sound is not None:
                sound.play()
    ...
    def play_animation_2(self):
        while self.exit_flag == False:
            if self.player2_animation is not None:
    ...
    def play_animation_2_step(self):
        if self.player2_animation is not None:
            sound = self.player2_animation['sound']
            if sound is not None:
                sound.play()
...
def play_animation(animation):
    image02 = np.zeros((480, 640, 3), np.uint8)
    cv2.rectangle(image02, (0, 0), (480, 640), (255, 255, 255), thickness=-1)
    cv2.imshow("image", image02)
    for frame in animation['frames']:
        # print(frame['body_points'])
        draw_stick_figure(image02, frame['body_points'])
        cv2.imshow("image", image02)
        cv2.waitKey(frame['delay'])
...
def draw_stick_figure(image, landmarks, color=(100, 33, 3), bg_color=(255, 255, 255)):
    ...
    # 背景色
    # Lucy cv2.rectangle(image, (0, 0), (image_width, image_height),bg_color,thickness=-1)
...
if __name__ == '__main__':
    ...
    # image0 = np.zeros((480, 640, 3), np.uint8)
    # cv2.rectangle(image0, (0, 0), (480, 640), (255, 255, 255), thickness=-1)
    # pk_animator = PkAnimator(image0)
    pk_animator = PkAnimator('background/back_pk.jpg')
    pk_animator.set_player1_animation(6)  # animation_standby#animation_standby #animation_punch
    pk_animator.set_player2_animation(6)  # animation_standby #animation_kick
    pk_animator.run()
    # cv2.waitKey(5000)
    # #player_pk_animator.exit_flag=True
    # pk_animator.player1_animation = animation_kick
    # pk_animator.player2_animation = animation_punch
    #
    # pass
    # cv2.imshow("image",image0)

    # play_animation(animation_punch)
